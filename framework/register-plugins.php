...
function houzez_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'   				=> get_template_directory_uri() . '/plugins/houzez-theme-functionality.zip', // The plugin source
		...
		array(
			...
			'source'   				=> get_template_directory_uri() . '/plugins/houzez-login-register.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
